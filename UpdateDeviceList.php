...
<body>
    <ul id="product-list" class="product-list">
        ...
        foreach ($device_list as $device) {
            ...
            echo "<form name='update-device' action='UpdateDevice.php' method='post'>
            <input type='hidden' name='DeviceIDUpdate' value='" . $dev_id . "' />
            <input type='submit' name='updateDev' value='Update Device' /></form>";
            echo "</li>";
        }
        ?>
    </ul>
